...
#include "Pawns/ZeroGCharacter.h"
...
void AZeroGCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AZeroGCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * BaseLookUpRate * GetWorld()->GetDeltaSeconds());
}

void AZeroGCharacter::MoveForward(float Value)
{
...
void AZeroGCharacter::MoveRight(float Value)
{
	if ( (Controller != NULL) && (Value != 0.0f) )
	{
